...
-- Auto-create non-overlapping bookings if missing (idempotent)
...
PRINT 'Session B (non-conflict) approving booking ' + CAST(@TargetId AS VARCHAR(10)) + ' ...';
...
PRINT 'Session B (non-conflict): SUCCEEDED (expected).';
GO
