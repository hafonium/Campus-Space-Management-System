...
-- File: outputs/13-concurrency-tests-G09/03a-session-A-nonconflict-G09.sql
-- Purpose: Session A of the non-conflicting-approval test (disjoint windows).
...
EXEC dbo.sp_approve_booking
    ...
    @decision_note     = 'Concurrent approval (Session A, non-conflict).';
